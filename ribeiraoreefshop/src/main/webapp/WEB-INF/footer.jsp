...
<footer class="page-footer text-center font-small mt-4 wow fadeIn">
	...
	<div class="pt-4">
		<a class="btn btn-outline-white"
			...
			role="button">Download MDB <i class="fa fa-download ml-2"></i>
	...
	<div class="footer-copyright py-3">
		© 2018 Copyright: <a
			href="https://mdbootstrap.com/bootstrap-tutorial/" target="_blank">
			Ribeirão Reef </a> - Todos os Direitos Reservados
	</div>
	<!--/.Copyright-->
...
<!-- Bootstrap tooltips -->
<script type="text/javascript" src="${path}/static/js/popper.min.js"></script>
<!-- Bootstrap core JavaScript -->
<script type="text/javascript" src="${path}/static/js/bootstrap.min.js"></script>
<!-- MDB core JavaScript -->
<script type="text/javascript" src="${path}/static/js/mdb.min.js"></script>
<!-- Initializations -->
<script type="text/javascript">
