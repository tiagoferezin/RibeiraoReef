...
@EnableJpaRepositories(basePackages = "br.com.ribeiraoreefshop.controleHorario.model.repositories")
public class ConfiguracaoDB {
	...
	public DataSource dataSource() throws IllegalStateException,
		...
		dataSource.setJdbcUrl("jdbc:postgresql://localhost:5432/controle");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory()
		...
		entityManagerFactoryBean
				.setPackagesToScan("br.com.ribeiraoreefshop.controleHorario.model.entity");
		entityManagerFactoryBean
